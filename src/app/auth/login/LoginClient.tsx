...
const pageStyle: React.CSSProperties = { minHeight: '100vh', background: '#F7F7F8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', position: 'relative', overflow: 'hidden' }
...
const brandStyle: React.CSSProperties = { fontSize: '1.4rem', fontWeight: 800, color: '#171717', letterSpacing: '-0.02em' }
const mutedStyle: React.CSSProperties = { color: '#737373', fontSize: '0.88rem' }
const cardStyle: React.CSSProperties = { background: '#FFFFFF', border: '1px solid rgba(23,23,23,0.08)', borderRadius: '20px', padding: '32px', boxShadow: '0 16px 48px rgba(23,23,23,0.10)' }
const headingStyle: React.CSSProperties = { fontSize: '1.3rem', fontWeight: 800, color: '#171717', marginBottom: '6px' }
const labelStyle: React.CSSProperties = { fontSize: '0.82rem', fontWeight: 600, color: '#737373', display: 'block', marginBottom: '6px' }
const inputStyle: React.CSSProperties = { width: '100%', padding: '11px 14px', marginBottom: '14px', background: '#F7F7F8', border: '1px solid rgba(23,23,23,0.12)', borderRadius: '10px', color: '#171717', fontSize: '0.95rem', fontFamily: 'inherit', outline: 'none', letterSpacing: '0.08em' }
...
const secondaryButtonStyle: React.CSSProperties = { background: 'none', border: 'none', color: '#737373', cursor: 'pointer', fontSize: '0.8rem', padding: '8px 0' }
const actionsStyle: React.CSSProperties = { display: 'flex', justifyContent: 'space-between', gap: '12px', marginTop: '10px' }
const feedbackStyle = (success: boolean): React.CSSProperties => ({ padding: '12px', background: success ? 'rgba(34,197,94,0.1)' : 'rgba(239,68,68,0.1)', border: `1px solid ${success ? 'rgba(34,197,94,0.25)' : 'rgba(239,68,68,0.25)'}`, borderRadius: '10px', marginBottom: '20px', fontSize: '0.85rem', color: success ? '#15803D' : '#B91C1C' })
