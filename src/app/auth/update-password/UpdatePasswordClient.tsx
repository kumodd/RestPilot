  ...
  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <h1 style={headingStyle}>Password updates unavailable</h1>
        <p style={textStyle}>RestPilot authentication is strictly email + one-time password. Use a fresh email code whenever you need to sign in.</p>
